...
```sh
ansible-galaxy install elastic.elasticsearch,v7.17.1
```
...
The above installs Elasticsearch 7.17.1 in a single node 'node1' on the hosts 'localhost'.
