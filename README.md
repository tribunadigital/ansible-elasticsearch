...
```sh
ansible-galaxy install elastic.elasticsearch,v7.17.13
```
...
The above installs Elasticsearch 7.17.13 in a single node 'node1' on the hosts 'localhost'.
